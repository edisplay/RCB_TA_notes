...
4. write a function that takes in 3 arguments, checks if the first letter of each are a vowel and if so then alert: first letters of arguments are vowels!
